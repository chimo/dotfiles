...
theme.wallpaper                     = theme.confdir .. "/wallpapers/bash.png"
...
theme.widget_bat_empty              = theme.confdir .. "/icons/bat_empty.png"
...
theme.arr01                         = theme.confdir .. "/icons/arr01.png"
